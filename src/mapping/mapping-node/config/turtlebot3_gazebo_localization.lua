...
include "turtlebot3_gazebo_base.lua"
...
POSE_GRAPH.global_sampling_ratio = .001
POSE_GRAPH.optimize_every_n_nodes = 2
POSE_GRAPH.global_constraint_search_after_n_seconds = 30

POSE_GRAPH.constraint_builder.min_score = .65
POSE_GRAPH.constraint_builder.global_localization_min_score = .75
