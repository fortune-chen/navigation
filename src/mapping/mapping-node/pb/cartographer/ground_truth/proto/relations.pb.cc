...
constexpr Relation::Relation(
  ...
  : expected_(nullptr)
  , timestamp1_(int64_t{0})
  , timestamp2_(int64_t{0})
  , covered_distance_(0){}
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_cartographer_2fground_5ftruth_2fproto_2frelations_2eproto = {
  false, false, 348, descriptor_table_protodef_cartographer_2fground_5ftruth_2fproto_2frelations_2eproto, "cartographer/ground_truth/proto/relations.proto", 
  ...
  file_level_metadata_cartographer_2fground_5ftruth_2fproto_2frelations_2eproto, file_level_enum_descriptors_cartographer_2fground_5ftruth_2fproto_2frelations_2eproto, file_level_service_descriptors_cartographer_2fground_5ftruth_2fproto_2frelations_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_cartographer_2fground_5ftruth_2fproto_2frelations_2eproto_getter() {
  return &descriptor_table_cartographer_2fground_5ftruth_2fproto_2frelations_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_cartographer_2fground_5ftruth_2fproto_2frelations_2eproto(&descriptor_table_cartographer_2fground_5ftruth_2fproto_2frelations_2eproto);
namespace cartographer {
namespace ground_truth {
namespace proto {
...
void Relation::clear_expected() {
  if (GetArenaForAllocation() == nullptr && expected_ != nullptr) {
    delete expected_;
  }
  expected_ = nullptr;
}
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    ...
    0, static_cast<size_t>(reinterpret_cast<char*>(&covered_distance_) -
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 8)) {
          timestamp1_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 16)) {
          timestamp2_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
::PROTOBUF_NAMESPACE_ID::uint8* Relation::_InternalSerialize(
  ...
  // double covered_distance = 4;
  if (!(this->_internal_covered_distance() <= 0 && this->_internal_covered_distance() >= 0)) {
    target = stream->EnsureSpace(target);
...
// @@protoc_insertion_point(message_byte_size_start:cartographer.ground_truth.proto.Relation)
  ...
  // int64 timestamp1 = 1;
  if (this->_internal_timestamp1() != 0) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int64SizePlusOne(this->_internal_timestamp1());
  }

  // int64 timestamp2 = 2;
  if (this->_internal_timestamp2() != 0) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int64SizePlusOne(this->_internal_timestamp2());
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:cartographer.ground_truth.proto.Relation)
  ...
  if (!(from._internal_covered_distance() <= 0 && from._internal_covered_distance() >= 0)) {
...
void Relation::InternalSwap(Relation* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(Relation, covered_distance_)
      + sizeof(Relation::covered_distance_)
      - PROTOBUF_FIELD_OFFSET(Relation, expected_)>(
