...
class TimestampedTransform final :
 ...
 public:
  ...
  explicit constexpr TimestampedTransform(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  PROTOBUF_MUST_USE_RESULT ::cartographer::transform::proto::Rigid3d* release_transform();
