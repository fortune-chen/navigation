...
inline bool GridOptions2D_GridType_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, GridOptions2D_GridType* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<GridOptions2D_GridType>(
    GridOptions2D_GridType_descriptor(), name, value);
}
// ===================================================================

class GridOptions2D final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:cartographer.mapping.proto.GridOptions2D) */ {
 public:
  inline GridOptions2D() : GridOptions2D(nullptr) {}
  ~GridOptions2D() override;
  explicit constexpr GridOptions2D(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void UnsafeArenaSwap(GridOptions2D* other) {
    if (other == this) return;
  ...
  protected:
  explicit GridOptions2D(::PROTOBUF_NAMESPACE_ID::Arena* arena,
