...
class LocalTrajectoryBuilderOptions2D final :
 ...
 public:
  ...
  explicit constexpr LocalTrajectoryBuilderOptions2D(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  inline LocalTrajectoryBuilderOptions2D* New() const final {
    return new LocalTrajectoryBuilderOptions2D();
  }
  ...
  PROTOBUF_MUST_USE_RESULT ::cartographer::sensor::proto::AdaptiveVoxelFilterOptions* release_adaptive_voxel_filter_options();
  ...
  PROTOBUF_MUST_USE_RESULT ::cartographer::mapping::proto::SubmapsOptions2D* release_submaps_options();
  ...
  PROTOBUF_MUST_USE_RESULT ::cartographer::sensor::proto::AdaptiveVoxelFilterOptions* release_loop_closure_adaptive_voxel_filter_options();
