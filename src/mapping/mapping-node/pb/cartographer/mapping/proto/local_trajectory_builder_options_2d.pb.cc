...
namespace mapping {
namespace proto {
constexpr LocalTrajectoryBuilderOptions2D::LocalTrajectoryBuilderOptions2D(
...
struct LocalTrajectoryBuilderOptions2DDefaultTypeInternal {
  constexpr LocalTrajectoryBuilderOptions2DDefaultTypeInternal()
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT LocalTrajectoryBuilderOptions2DDefaultTypeInternal _LocalTrajectoryBuilderOptions2D_default_instance_;
}  // namespace proto
}  // namespace mapping
}  // namespace cartographer
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_cartographer_2fmapping_2fproto_2flocal_5ftrajectory_5fbuilder_5foptions_5f2d_2eproto = {
  false, false, 1489, descriptor_table_protodef_cartographer_2fmapping_2fproto_2flocal_5ftrajectory_5fbuilder_5foptions_5f2d_2eproto, "cartographer/mapping/proto/local_trajectory_builder_options_2d.proto", 
  ...
  file_level_metadata_cartographer_2fmapping_2fproto_2flocal_5ftrajectory_5fbuilder_5foptions_5f2d_2eproto, file_level_enum_descriptors_cartographer_2fmapping_2fproto_2flocal_5ftrajectory_5fbuilder_5foptions_5f2d_2eproto, file_level_service_descriptors_cartographer_2fmapping_2fproto_2flocal_5ftrajectory_5fbuilder_5foptions_5f2d_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_cartographer_2fmapping_2fproto_2flocal_5ftrajectory_5fbuilder_5foptions_5f2d_2eproto_getter() {
  return &descriptor_table_cartographer_2fmapping_2fproto_2flocal_5ftrajectory_5fbuilder_5foptions_5f2d_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_cartographer_2fmapping_2fproto_2flocal_5ftrajectory_5fbuilder_5foptions_5f2d_2eproto(&descriptor_table_cartographer_2fmapping_2fproto_2flocal_5ftrajectory_5fbuilder_5foptions_5f2d_2eproto);
namespace cartographer {
namespace mapping {
namespace proto {
...
void LocalTrajectoryBuilderOptions2D::clear_adaptive_voxel_filter_options() {
  if (GetArenaForAllocation() == nullptr && adaptive_voxel_filter_options_ != nullptr) {
...
void LocalTrajectoryBuilderOptions2D::clear_loop_closure_adaptive_voxel_filter_options() {
  if (GetArenaForAllocation() == nullptr && loop_closure_adaptive_voxel_filter_options_ != nullptr) {
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    reinterpret_cast<char*>(&adaptive_voxel_filter_options_) - reinterpret_cast<char*>(this)),
    0, static_cast<size_t>(reinterpret_cast<char*>(&num_accumulated_range_data_) -
...
void LocalTrajectoryBuilderOptions2D::ArenaDtor(void* object) {
  LocalTrajectoryBuilderOptions2D* _this = reinterpret_cast< LocalTrajectoryBuilderOptions2D* >(object);
  (void)_this;
}
void LocalTrajectoryBuilderOptions2D::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
    ...
    switch (tag >> 3) {
      ...
      case 12:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 96)) {
          use_imu_data_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
::PROTOBUF_NAMESPACE_ID::uint8* LocalTrajectoryBuilderOptions2D::_InternalSerialize(
  ...
  // float missing_data_ray_length = 16;
  if (!(this->_internal_missing_data_ray_length() <= 0 && this->_internal_missing_data_ray_length() >= 0)) {
    target = stream->EnsureSpace(target);
...
void LocalTrajectoryBuilderOptions2D::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<LocalTrajectoryBuilderOptions2D *>(to)->MergeFrom(
      static_cast<const LocalTrajectoryBuilderOptions2D &>(from));
}
...
// @@protoc_insertion_point(class_specific_merge_from_start:cartographer.mapping.proto.LocalTrajectoryBuilderOptions2D)
  ...
  if (!(from._internal_min_z() <= 0 && from._internal_min_z() >= 0)) {
    _internal_set_min_z(from._internal_min_z());
  }
  if (!(from._internal_max_z() <= 0 && from._internal_max_z() >= 0)) {
  ...
  if (!(from._internal_missing_data_ray_length() <= 0 && from._internal_missing_data_ray_length() >= 0)) {
...
void LocalTrajectoryBuilderOptions2D::InternalSwap(LocalTrajectoryBuilderOptions2D* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(LocalTrajectoryBuilderOptions2D, num_accumulated_range_data_)
      + sizeof(LocalTrajectoryBuilderOptions2D::num_accumulated_range_data_)
      - PROTOBUF_FIELD_OFFSET(LocalTrajectoryBuilderOptions2D, adaptive_voxel_filter_options_)>(
          reinterpret_cast<char*>(&adaptive_voxel_filter_options_),
          reinterpret_cast<char*>(&other->adaptive_voxel_filter_options_));
}
