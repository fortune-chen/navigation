...
class MapBuilderOptions final :
 ...
 public:
  ...
  explicit constexpr MapBuilderOptions(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  PROTOBUF_MUST_USE_RESULT ::cartographer::mapping::proto::PoseGraphOptions* release_pose_graph_options();
