...
class ProbabilityGridRangeDataInserterOptions2D final :
 ...
 public:
  inline ProbabilityGridRangeDataInserterOptions2D() : ProbabilityGridRangeDataInserterOptions2D(nullptr) {}
  ~ProbabilityGridRangeDataInserterOptions2D() override;
  explicit constexpr ProbabilityGridRangeDataInserterOptions2D(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void UnsafeArenaSwap(ProbabilityGridRangeDataInserterOptions2D* other) {
    if (other == this) return;
  ...
  inline ProbabilityGridRangeDataInserterOptions2D* New() const final {
    return new ProbabilityGridRangeDataInserterOptions2D();
  }
  ...
  protected:
  explicit ProbabilityGridRangeDataInserterOptions2D(::PROTOBUF_NAMESPACE_ID::Arena* arena,
