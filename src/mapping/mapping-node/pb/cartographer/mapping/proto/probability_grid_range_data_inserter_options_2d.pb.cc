...
namespace mapping {
namespace proto {
constexpr ProbabilityGridRangeDataInserterOptions2D::ProbabilityGridRangeDataInserterOptions2D(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : hit_probability_(0)
  , miss_probability_(0)
  , insert_free_space_(false){}
struct ProbabilityGridRangeDataInserterOptions2DDefaultTypeInternal {
  constexpr ProbabilityGridRangeDataInserterOptions2DDefaultTypeInternal()
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT ProbabilityGridRangeDataInserterOptions2DDefaultTypeInternal _ProbabilityGridRangeDataInserterOptions2D_default_instance_;
}  // namespace proto
}  // namespace mapping
}  // namespace cartographer
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_cartographer_2fmapping_2fproto_2fprobability_5fgrid_5frange_5fdata_5finserter_5foptions_5f2d_2eproto = {
  false, false, 241, descriptor_table_protodef_cartographer_2fmapping_2fproto_2fprobability_5fgrid_5frange_5fdata_5finserter_5foptions_5f2d_2eproto, "cartographer/mapping/proto/probability_grid_range_data_inserter_options_2d.proto", 
  ...
  file_level_metadata_cartographer_2fmapping_2fproto_2fprobability_5fgrid_5frange_5fdata_5finserter_5foptions_5f2d_2eproto, file_level_enum_descriptors_cartographer_2fmapping_2fproto_2fprobability_5fgrid_5frange_5fdata_5finserter_5foptions_5f2d_2eproto, file_level_service_descriptors_cartographer_2fmapping_2fproto_2fprobability_5fgrid_5frange_5fdata_5finserter_5foptions_5f2d_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_cartographer_2fmapping_2fproto_2fprobability_5fgrid_5frange_5fdata_5finserter_5foptions_5f2d_2eproto_getter() {
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_cartographer_2fmapping_2fproto_2fprobability_5fgrid_5frange_5fdata_5finserter_5foptions_5f2d_2eproto(&descriptor_table_cartographer_2fmapping_2fproto_2fprobability_5fgrid_5frange_5fdata_5finserter_5foptions_5f2d_2eproto);
namespace cartographer {
namespace mapping {
namespace proto {
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    ...
    0, static_cast<size_t>(reinterpret_cast<char*>(&insert_free_space_) -
    reinterpret_cast<char*>(&hit_probability_)) + sizeof(insert_free_space_));
}
...
void ProbabilityGridRangeDataInserterOptions2D::ArenaDtor(void* object) {
  ProbabilityGridRangeDataInserterOptions2D* _this = reinterpret_cast< ProbabilityGridRangeDataInserterOptions2D* >(object);
  (void)_this;
}
void ProbabilityGridRangeDataInserterOptions2D::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 24)) {
          insert_free_space_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
void ProbabilityGridRangeDataInserterOptions2D::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<ProbabilityGridRangeDataInserterOptions2D *>(to)->MergeFrom(
      static_cast<const ProbabilityGridRangeDataInserterOptions2D &>(from));
}
...
void ProbabilityGridRangeDataInserterOptions2D::InternalSwap(ProbabilityGridRangeDataInserterOptions2D* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(ProbabilityGridRangeDataInserterOptions2D, insert_free_space_)
      + sizeof(ProbabilityGridRangeDataInserterOptions2D::insert_free_space_)
      - PROTOBUF_FIELD_OFFSET(ProbabilityGridRangeDataInserterOptions2D, hit_probability_)>(
