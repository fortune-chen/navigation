...
class TSDFRangeDataInserterOptions2D final :
 ...
 public:
  inline TSDFRangeDataInserterOptions2D() : TSDFRangeDataInserterOptions2D(nullptr) {}
  ~TSDFRangeDataInserterOptions2D() override;
  explicit constexpr TSDFRangeDataInserterOptions2D(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void UnsafeArenaSwap(TSDFRangeDataInserterOptions2D* other) {
    if (other == this) return;
  ...
  inline TSDFRangeDataInserterOptions2D* New() const final {
    return new TSDFRangeDataInserterOptions2D();
  }
  ...
  protected:
  explicit TSDFRangeDataInserterOptions2D(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  PROTOBUF_MUST_USE_RESULT ::cartographer::mapping::proto::NormalEstimationOptions2D* release_normal_estimation_options();
  ...
  public:
  void unsafe_arena_set_allocated_normal_estimation_options(
      ::cartographer::mapping::proto::NormalEstimationOptions2D* normal_estimation_options);
  ::cartographer::mapping::proto::NormalEstimationOptions2D* unsafe_arena_release_normal_estimation_options();
...
inline void TSDFRangeDataInserterOptions2D::unsafe_arena_set_allocated_normal_estimation_options(
    ::cartographer::mapping::proto::NormalEstimationOptions2D* normal_estimation_options) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:cartographer.mapping.proto.TSDFRangeDataInserterOptions2D.normal_estimation_options)
}
...
inline ::cartographer::mapping::proto::NormalEstimationOptions2D* TSDFRangeDataInserterOptions2D::unsafe_arena_release_normal_estimation_options() {
...
inline ::cartographer::mapping::proto::NormalEstimationOptions2D* TSDFRangeDataInserterOptions2D::_internal_mutable_normal_estimation_options() {
  ...
  if (normal_estimation_options_ == nullptr) {
    auto* p = CreateMaybeMessage<::cartographer::mapping::proto::NormalEstimationOptions2D>(GetArenaForAllocation());
...
inline ::cartographer::mapping::proto::NormalEstimationOptions2D* TSDFRangeDataInserterOptions2D::mutable_normal_estimation_options() {
  ::cartographer::mapping::proto::NormalEstimationOptions2D* _msg = _internal_mutable_normal_estimation_options();
    ...
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<
            ::PROTOBUF_NAMESPACE_ID::MessageLite>::GetOwningArena(
                reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(normal_estimation_options));
