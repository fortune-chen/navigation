...
namespace proto {
constexpr OptimizationProblemOptions::OptimizationProblemOptions(
...
struct OptimizationProblemOptionsDefaultTypeInternal {
  constexpr OptimizationProblemOptionsDefaultTypeInternal()
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT OptimizationProblemOptionsDefaultTypeInternal _OptimizationProblemOptions_default_instance_;
}  // namespace proto
}  // namespace optimization
}  // namespace mapping
}  // namespace cartographer
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_cartographer_2fmapping_2fproto_2fpose_5fgraph_2foptimization_5fproblem_5foptions_2eproto = {
  false, false, 839, descriptor_table_protodef_cartographer_2fmapping_2fproto_2fpose_5fgraph_2foptimization_5fproblem_5foptions_2eproto, "cartographer/mapping/proto/pose_graph/optimization_problem_options.proto", 
  ...
  file_level_metadata_cartographer_2fmapping_2fproto_2fpose_5fgraph_2foptimization_5fproblem_5foptions_2eproto, file_level_enum_descriptors_cartographer_2fmapping_2fproto_2fpose_5fgraph_2foptimization_5fproblem_5foptions_2eproto, file_level_service_descriptors_cartographer_2fmapping_2fproto_2fpose_5fgraph_2foptimization_5fproblem_5foptions_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_cartographer_2fmapping_2fproto_2fpose_5fgraph_2foptimization_5fproblem_5foptions_2eproto_getter() {
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_cartographer_2fmapping_2fproto_2fpose_5fgraph_2foptimization_5fproblem_5foptions_2eproto(&descriptor_table_cartographer_2fmapping_2fproto_2fpose_5fgraph_2foptimization_5fproblem_5foptions_2eproto);
namespace cartographer {
namespace mapping {
namespace optimization {
namespace proto {
...
void OptimizationProblemOptions::clear_ceres_solver_options() {
  if (GetArenaForAllocation() == nullptr && ceres_solver_options_ != nullptr) {
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    reinterpret_cast<char*>(&ceres_solver_options_) - reinterpret_cast<char*>(this)),
    0, static_cast<size_t>(reinterpret_cast<char*>(&fixed_frame_pose_tolerant_loss_param_b_) -
...
::PROTOBUF_NAMESPACE_ID::uint8* OptimizationProblemOptions::_InternalSerialize(
  ...
  // double huber_scale = 1;
  if (!(this->_internal_huber_scale() <= 0 && this->_internal_huber_scale() >= 0)) {
  ...
  // double acceleration_weight = 8;
  if (!(this->_internal_acceleration_weight() <= 0 && this->_internal_acceleration_weight() >= 0)) {
    target = stream->EnsureSpace(target);
  ...
  // double fixed_frame_pose_translation_weight = 11;
  if (!(this->_internal_fixed_frame_pose_translation_weight() <= 0 && this->_internal_fixed_frame_pose_translation_weight() >= 0)) {
    target = stream->EnsureSpace(target);
  ...
  // double fixed_frame_pose_rotation_weight = 12;
  if (!(this->_internal_fixed_frame_pose_rotation_weight() <= 0 && this->_internal_fixed_frame_pose_rotation_weight() >= 0)) {
    target = stream->EnsureSpace(target);
  ...
  // double local_slam_pose_translation_weight = 14;
  if (!(this->_internal_local_slam_pose_translation_weight() <= 0 && this->_internal_local_slam_pose_translation_weight() >= 0)) {
    target = stream->EnsureSpace(target);
  ...
  // double local_slam_pose_rotation_weight = 15;
  if (!(this->_internal_local_slam_pose_rotation_weight() <= 0 && this->_internal_local_slam_pose_rotation_weight() >= 0)) {
    target = stream->EnsureSpace(target);
  ...
  // double fixed_frame_pose_tolerant_loss_param_a = 24;
  if (!(this->_internal_fixed_frame_pose_tolerant_loss_param_a() <= 0 && this->_internal_fixed_frame_pose_tolerant_loss_param_a() >= 0)) {
    target = stream->EnsureSpace(target);
  ...
  // double fixed_frame_pose_tolerant_loss_param_b = 25;
  if (!(this->_internal_fixed_frame_pose_tolerant_loss_param_b() <= 0 && this->_internal_fixed_frame_pose_tolerant_loss_param_b() >= 0)) {
    target = stream->EnsureSpace(target);
...
void OptimizationProblemOptions::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<OptimizationProblemOptions *>(to)->MergeFrom(
      static_cast<const OptimizationProblemOptions &>(from));
}
...
// @@protoc_insertion_point(class_specific_merge_from_start:cartographer.mapping.optimization.proto.OptimizationProblemOptions)
  ...
  if (!(from._internal_huber_scale() <= 0 && from._internal_huber_scale() >= 0)) {
    _internal_set_huber_scale(from._internal_huber_scale());
  }
  if (!(from._internal_acceleration_weight() <= 0 && from._internal_acceleration_weight() >= 0)) {
  ...
  if (!(from._internal_fixed_frame_pose_translation_weight() <= 0 && from._internal_fixed_frame_pose_translation_weight() >= 0)) {
    _internal_set_fixed_frame_pose_translation_weight(from._internal_fixed_frame_pose_translation_weight());
  }
  if (!(from._internal_fixed_frame_pose_rotation_weight() <= 0 && from._internal_fixed_frame_pose_rotation_weight() >= 0)) {
    _internal_set_fixed_frame_pose_rotation_weight(from._internal_fixed_frame_pose_rotation_weight());
  }
  if (!(from._internal_local_slam_pose_translation_weight() <= 0 && from._internal_local_slam_pose_translation_weight() >= 0)) {
    _internal_set_local_slam_pose_translation_weight(from._internal_local_slam_pose_translation_weight());
  }
  if (!(from._internal_local_slam_pose_rotation_weight() <= 0 && from._internal_local_slam_pose_rotation_weight() >= 0)) {
  ...
  if (!(from._internal_fixed_frame_pose_tolerant_loss_param_a() <= 0 && from._internal_fixed_frame_pose_tolerant_loss_param_a() >= 0)) {
    _internal_set_fixed_frame_pose_tolerant_loss_param_a(from._internal_fixed_frame_pose_tolerant_loss_param_a());
  }
  if (!(from._internal_fixed_frame_pose_tolerant_loss_param_b() <= 0 && from._internal_fixed_frame_pose_tolerant_loss_param_b() >= 0)) {
