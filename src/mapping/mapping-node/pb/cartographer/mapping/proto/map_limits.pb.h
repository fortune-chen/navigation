...
class MapLimits final :
 ...
 public:
  ...
  ~MapLimits() override;
  explicit constexpr MapLimits(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  PROTOBUF_MUST_USE_RESULT ::cartographer::transform::proto::Vector2d* release_max();
  ...
  PROTOBUF_MUST_USE_RESULT ::cartographer::mapping::proto::CellLimits* release_cell_limits();
