...
class SubmapsOptions3D final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:cartographer.mapping.proto.SubmapsOptions3D) */ {
 public:
  inline SubmapsOptions3D() : SubmapsOptions3D(nullptr) {}
  ~SubmapsOptions3D() override;
  explicit constexpr SubmapsOptions3D(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void UnsafeArenaSwap(SubmapsOptions3D* other) {
    if (other == this) return;
  ...
  protected:
  explicit SubmapsOptions3D(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  PROTOBUF_MUST_USE_RESULT ::cartographer::mapping::proto::RangeDataInserterOptions3D* release_range_data_inserter_options();
  ...
  ::cartographer::mapping::proto::RangeDataInserterOptions3D* unsafe_arena_release_range_data_inserter_options();
...
inline void SubmapsOptions3D::unsafe_arena_set_allocated_range_data_inserter_options(
    ::cartographer::mapping::proto::RangeDataInserterOptions3D* range_data_inserter_options) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:cartographer.mapping.proto.SubmapsOptions3D.range_data_inserter_options)
}
...
inline ::cartographer::mapping::proto::RangeDataInserterOptions3D* SubmapsOptions3D::unsafe_arena_release_range_data_inserter_options() {
...
inline ::cartographer::mapping::proto::RangeDataInserterOptions3D* SubmapsOptions3D::_internal_mutable_range_data_inserter_options() {
  ...
  if (range_data_inserter_options_ == nullptr) {
    auto* p = CreateMaybeMessage<::cartographer::mapping::proto::RangeDataInserterOptions3D>(GetArenaForAllocation());
...
inline ::cartographer::mapping::proto::RangeDataInserterOptions3D* SubmapsOptions3D::mutable_range_data_inserter_options() {
  ::cartographer::mapping::proto::RangeDataInserterOptions3D* _msg = _internal_mutable_range_data_inserter_options();
