...
#ifndef GOOGLE_PROTOBUF_INCLUDED_cartographer_2fmapping_2fproto_2flocal_5ftrajectory_5fbuilder_5foptions_5f3d_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_cartographer_2fmapping_2fproto_2flocal_5ftrajectory_5fbuilder_5foptions_5f3d_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_cartographer_2fmapping_2fproto_2flocal_5ftrajectory_5fbuilder_5foptions_5f3d_2eproto
...
struct TableStruct_cartographer_2fmapping_2fproto_2flocal_5ftrajectory_5fbuilder_5foptions_5f3d_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_cartographer_2fmapping_2fproto_2flocal_5ftrajectory_5fbuilder_5foptions_5f3d_2eproto;
namespace cartographer {
namespace mapping {
namespace proto {
class LocalTrajectoryBuilderOptions3D;
struct LocalTrajectoryBuilderOptions3DDefaultTypeInternal;
extern LocalTrajectoryBuilderOptions3DDefaultTypeInternal _LocalTrajectoryBuilderOptions3D_default_instance_;
}  // namespace proto
}  // namespace mapping
}  // namespace cartographer
PROTOBUF_NAMESPACE_OPEN
template<> ::cartographer::mapping::proto::LocalTrajectoryBuilderOptions3D* Arena::CreateMaybeMessage<::cartographer::mapping::proto::LocalTrajectoryBuilderOptions3D>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace cartographer {
namespace mapping {
namespace proto {
...
class LocalTrajectoryBuilderOptions3D final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:cartographer.mapping.proto.LocalTrajectoryBuilderOptions3D) */ {
 public:
  inline LocalTrajectoryBuilderOptions3D() : LocalTrajectoryBuilderOptions3D(nullptr) {}
  ~LocalTrajectoryBuilderOptions3D() override;
  explicit constexpr LocalTrajectoryBuilderOptions3D(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  inline void Swap(LocalTrajectoryBuilderOptions3D* other) {
  ...
  void UnsafeArenaSwap(LocalTrajectoryBuilderOptions3D* other) {
    if (other == this) return;
  ...
  inline LocalTrajectoryBuilderOptions3D* New() const final {
    return new LocalTrajectoryBuilderOptions3D();
  }

  LocalTrajectoryBuilderOptions3D* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<LocalTrajectoryBuilderOptions3D>(arena);
  }
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "cartographer.mapping.proto.LocalTrajectoryBuilderOptions3D";
  }
  protected:
  explicit LocalTrajectoryBuilderOptions3D(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  enum : int {
    kInitialPosesFieldNumber = 19,
    kInitialImuDataFieldNumber = 20,
    kHighResolutionAdaptiveVoxelFilterOptionsFieldNumber = 5,
    kCeresScanMatcherOptionsFieldNumber = 6,
    kMotionFilterOptionsFieldNumber = 7,
    kSubmapsOptionsFieldNumber = 8,
    kLowResolutionAdaptiveVoxelFilterOptionsFieldNumber = 12,
    kRealTimeCorrelativeScanMatcherOptionsFieldNumber = 14,
    kPoseExtrapolatorOptionsFieldNumber = 18,
    kMinRangeFieldNumber = 1,
    kMaxRangeFieldNumber = 2,
    kNumAccumulatedRangeDataFieldNumber = 3,
    kVoxelFilterSizeFieldNumber = 4,
    kImuGravityTimeConstantFieldNumber = 15,
    kRotationalHistogramSizeFieldNumber = 17,
    kUseOnlineCorrelativeScanMatchingFieldNumber = 13,
    kUseIntensitiesFieldNumber = 21,
  };
  // repeated .cartographer.transform.proto.TimestampedTransform initial_poses = 19;
  int initial_poses_size() const;
  private:
  int _internal_initial_poses_size() const;
  public:
  void clear_initial_poses();
  ::cartographer::transform::proto::TimestampedTransform* mutable_initial_poses(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::cartographer::transform::proto::TimestampedTransform >*
      mutable_initial_poses();
  private:
  const ::cartographer::transform::proto::TimestampedTransform& _internal_initial_poses(int index) const;
  ::cartographer::transform::proto::TimestampedTransform* _internal_add_initial_poses();
  public:
  ...
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::cartographer::transform::proto::TimestampedTransform >&
      initial_poses() const;

  // repeated .cartographer.sensor.proto.ImuData initial_imu_data = 20;
  int initial_imu_data_size() const;
  private:
  int _internal_initial_imu_data_size() const;
  public:
  void clear_initial_imu_data();
  ::cartographer::sensor::proto::ImuData* mutable_initial_imu_data(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::cartographer::sensor::proto::ImuData >*
      mutable_initial_imu_data();
  private:
  const ::cartographer::sensor::proto::ImuData& _internal_initial_imu_data(int index) const;
  ::cartographer::sensor::proto::ImuData* _internal_add_initial_imu_data();
  public:
  ...
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::cartographer::sensor::proto::ImuData >&
  ...
  private:
  bool _internal_has_high_resolution_adaptive_voxel_filter_options() const;
  public:
  ...
  PROTOBUF_MUST_USE_RESULT ::cartographer::sensor::proto::AdaptiveVoxelFilterOptions* release_high_resolution_adaptive_voxel_filter_options();
  ...
  private:
  const ::cartographer::sensor::proto::AdaptiveVoxelFilterOptions& _internal_high_resolution_adaptive_voxel_filter_options() const;
  ::cartographer::sensor::proto::AdaptiveVoxelFilterOptions* _internal_mutable_high_resolution_adaptive_voxel_filter_options();
  public:
  void unsafe_arena_set_allocated_high_resolution_adaptive_voxel_filter_options(
      ::cartographer::sensor::proto::AdaptiveVoxelFilterOptions* high_resolution_adaptive_voxel_filter_options);
  ::cartographer::sensor::proto::AdaptiveVoxelFilterOptions* unsafe_arena_release_high_resolution_adaptive_voxel_filter_options();
  ...
  PROTOBUF_MUST_USE_RESULT ::cartographer::mapping::scan_matching::proto::CeresScanMatcherOptions3D* release_ceres_scan_matcher_options();
  ...
  private:
  const ::cartographer::mapping::scan_matching::proto::CeresScanMatcherOptions3D& _internal_ceres_scan_matcher_options() const;
  ::cartographer::mapping::scan_matching::proto::CeresScanMatcherOptions3D* _internal_mutable_ceres_scan_matcher_options();
  public:
  void unsafe_arena_set_allocated_ceres_scan_matcher_options(
      ::cartographer::mapping::scan_matching::proto::CeresScanMatcherOptions3D* ceres_scan_matcher_options);
  ::cartographer::mapping::scan_matching::proto::CeresScanMatcherOptions3D* unsafe_arena_release_ceres_scan_matcher_options();
  ...
  PROTOBUF_MUST_USE_RESULT ::cartographer::mapping::proto::MotionFilterOptions* release_motion_filter_options();
  ...
  PROTOBUF_MUST_USE_RESULT ::cartographer::mapping::proto::SubmapsOptions3D* release_submaps_options();
  ...
  private:
  const ::cartographer::mapping::proto::SubmapsOptions3D& _internal_submaps_options() const;
  ::cartographer::mapping::proto::SubmapsOptions3D* _internal_mutable_submaps_options();
  public:
  void unsafe_arena_set_allocated_submaps_options(
      ::cartographer::mapping::proto::SubmapsOptions3D* submaps_options);
  ::cartographer::mapping::proto::SubmapsOptions3D* unsafe_arena_release_submaps_options();
  ...
  private:
  bool _internal_has_low_resolution_adaptive_voxel_filter_options() const;
  public:
  ...
  PROTOBUF_MUST_USE_RESULT ::cartographer::sensor::proto::AdaptiveVoxelFilterOptions* release_low_resolution_adaptive_voxel_filter_options();
  ...
  private:
  const ::cartographer::sensor::proto::AdaptiveVoxelFilterOptions& _internal_low_resolution_adaptive_voxel_filter_options() const;
  ::cartographer::sensor::proto::AdaptiveVoxelFilterOptions* _internal_mutable_low_resolution_adaptive_voxel_filter_options();
  public:
  void unsafe_arena_set_allocated_low_resolution_adaptive_voxel_filter_options(
      ::cartographer::sensor::proto::AdaptiveVoxelFilterOptions* low_resolution_adaptive_voxel_filter_options);
  ::cartographer::sensor::proto::AdaptiveVoxelFilterOptions* unsafe_arena_release_low_resolution_adaptive_voxel_filter_options();
  ...
  PROTOBUF_MUST_USE_RESULT ::cartographer::mapping::scan_matching::proto::RealTimeCorrelativeScanMatcherOptions* release_real_time_correlative_scan_matcher_options();
  ...
  PROTOBUF_MUST_USE_RESULT ::cartographer::mapping::proto::PoseExtrapolatorOptions* release_pose_extrapolator_options();
  ...
  ::PROTOBUF_NAMESPACE_ID::int32 rotational_histogram_size() const;
  void set_rotational_histogram_size(::PROTOBUF_NAMESPACE_ID::int32 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::int32 _internal_rotational_histogram_size() const;
  void _internal_set_rotational_histogram_size(::PROTOBUF_NAMESPACE_ID::int32 value);
  public:
  ...
  private:
  bool _internal_use_intensities() const;
  void _internal_set_use_intensities(bool value);
  public:
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::cartographer::transform::proto::TimestampedTransform > initial_poses_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::cartographer::sensor::proto::ImuData > initial_imu_data_;
  ...
  ::PROTOBUF_NAMESPACE_ID::int32 rotational_histogram_size_;
  bool use_online_correlative_scan_matching_;
  bool use_intensities_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_cartographer_2fmapping_2fproto_2flocal_5ftrajectory_5fbuilder_5foptions_5f3d_2eproto;
};
// ===================================================================
...
inline float LocalTrajectoryBuilderOptions3D::_internal_min_range() const {
  return min_range_;
}
...
inline void LocalTrajectoryBuilderOptions3D::_internal_set_min_range(float value) {
...
inline float LocalTrajectoryBuilderOptions3D::_internal_max_range() const {
  return max_range_;
}
...
inline void LocalTrajectoryBuilderOptions3D::_internal_set_max_range(float value) {
...
inline ::PROTOBUF_NAMESPACE_ID::int32 LocalTrajectoryBuilderOptions3D::_internal_num_accumulated_range_data() const {
  return num_accumulated_range_data_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 LocalTrajectoryBuilderOptions3D::num_accumulated_range_data() const {
...
inline void LocalTrajectoryBuilderOptions3D::_internal_set_num_accumulated_range_data(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  num_accumulated_range_data_ = value;
}
inline void LocalTrajectoryBuilderOptions3D::set_num_accumulated_range_data(::PROTOBUF_NAMESPACE_ID::int32 value) {
...
inline float LocalTrajectoryBuilderOptions3D::_internal_voxel_filter_size() const {
...
inline void LocalTrajectoryBuilderOptions3D::_internal_set_voxel_filter_size(float value) {
...
// .cartographer.sensor.proto.AdaptiveVoxelFilterOptions high_resolution_adaptive_voxel_filter_options = 5;
inline bool LocalTrajectoryBuilderOptions3D::_internal_has_high_resolution_adaptive_voxel_filter_options() const {
  return this != internal_default_instance() && high_resolution_adaptive_voxel_filter_options_ != nullptr;
}
inline bool LocalTrajectoryBuilderOptions3D::has_high_resolution_adaptive_voxel_filter_options() const {
  return _internal_has_high_resolution_adaptive_voxel_filter_options();
}
inline const ::cartographer::sensor::proto::AdaptiveVoxelFilterOptions& LocalTrajectoryBuilderOptions3D::_internal_high_resolution_adaptive_voxel_filter_options() const {
...
inline const ::cartographer::sensor::proto::AdaptiveVoxelFilterOptions& LocalTrajectoryBuilderOptions3D::high_resolution_adaptive_voxel_filter_options() const {
  ...
  return _internal_high_resolution_adaptive_voxel_filter_options();
}
inline void LocalTrajectoryBuilderOptions3D::unsafe_arena_set_allocated_high_resolution_adaptive_voxel_filter_options(
    ::cartographer::sensor::proto::AdaptiveVoxelFilterOptions* high_resolution_adaptive_voxel_filter_options) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(high_resolution_adaptive_voxel_filter_options_);
  }
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:cartographer.mapping.proto.LocalTrajectoryBuilderOptions3D.high_resolution_adaptive_voxel_filter_options)
}
...
inline ::cartographer::sensor::proto::AdaptiveVoxelFilterOptions* LocalTrajectoryBuilderOptions3D::unsafe_arena_release_high_resolution_adaptive_voxel_filter_options() {
...
inline ::cartographer::sensor::proto::AdaptiveVoxelFilterOptions* LocalTrajectoryBuilderOptions3D::_internal_mutable_high_resolution_adaptive_voxel_filter_options() {
  
  if (high_resolution_adaptive_voxel_filter_options_ == nullptr) {
    auto* p = CreateMaybeMessage<::cartographer::sensor::proto::AdaptiveVoxelFilterOptions>(GetArenaForAllocation());
    high_resolution_adaptive_voxel_filter_options_ = p;
  }
...
inline ::cartographer::sensor::proto::AdaptiveVoxelFilterOptions* LocalTrajectoryBuilderOptions3D::mutable_high_resolution_adaptive_voxel_filter_options() {
  ::cartographer::sensor::proto::AdaptiveVoxelFilterOptions* _msg = _internal_mutable_high_resolution_adaptive_voxel_filter_options();
    ...
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<
            ::PROTOBUF_NAMESPACE_ID::MessageLite>::GetOwningArena(
                reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(high_resolution_adaptive_voxel_filter_options));
    if (message_arena != submessage_arena) {
      high_resolution_adaptive_voxel_filter_options = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
...
// .cartographer.sensor.proto.AdaptiveVoxelFilterOptions low_resolution_adaptive_voxel_filter_options = 12;
inline bool LocalTrajectoryBuilderOptions3D::_internal_has_low_resolution_adaptive_voxel_filter_options() const {
  return this != internal_default_instance() && low_resolution_adaptive_voxel_filter_options_ != nullptr;
}
inline bool LocalTrajectoryBuilderOptions3D::has_low_resolution_adaptive_voxel_filter_options() const {
  return _internal_has_low_resolution_adaptive_voxel_filter_options();
}
inline const ::cartographer::sensor::proto::AdaptiveVoxelFilterOptions& LocalTrajectoryBuilderOptions3D::_internal_low_resolution_adaptive_voxel_filter_options() const {
...
inline const ::cartographer::sensor::proto::AdaptiveVoxelFilterOptions& LocalTrajectoryBuilderOptions3D::low_resolution_adaptive_voxel_filter_options() const {
  ...
  return _internal_low_resolution_adaptive_voxel_filter_options();
}
inline void LocalTrajectoryBuilderOptions3D::unsafe_arena_set_allocated_low_resolution_adaptive_voxel_filter_options(
    ::cartographer::sensor::proto::AdaptiveVoxelFilterOptions* low_resolution_adaptive_voxel_filter_options) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(low_resolution_adaptive_voxel_filter_options_);
  }
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:cartographer.mapping.proto.LocalTrajectoryBuilderOptions3D.low_resolution_adaptive_voxel_filter_options)
}
...
inline ::cartographer::sensor::proto::AdaptiveVoxelFilterOptions* LocalTrajectoryBuilderOptions3D::unsafe_arena_release_low_resolution_adaptive_voxel_filter_options() {
...
inline ::cartographer::sensor::proto::AdaptiveVoxelFilterOptions* LocalTrajectoryBuilderOptions3D::_internal_mutable_low_resolution_adaptive_voxel_filter_options() {
  
  if (low_resolution_adaptive_voxel_filter_options_ == nullptr) {
    auto* p = CreateMaybeMessage<::cartographer::sensor::proto::AdaptiveVoxelFilterOptions>(GetArenaForAllocation());
    low_resolution_adaptive_voxel_filter_options_ = p;
  }
...
inline ::cartographer::sensor::proto::AdaptiveVoxelFilterOptions* LocalTrajectoryBuilderOptions3D::mutable_low_resolution_adaptive_voxel_filter_options() {
  ::cartographer::sensor::proto::AdaptiveVoxelFilterOptions* _msg = _internal_mutable_low_resolution_adaptive_voxel_filter_options();
...
inline void LocalTrajectoryBuilderOptions3D::set_allocated_low_resolution_adaptive_voxel_filter_options(::cartographer::sensor::proto::AdaptiveVoxelFilterOptions* low_resolution_adaptive_voxel_filter_options) {
  ...
  if (low_resolution_adaptive_voxel_filter_options) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<
            ::PROTOBUF_NAMESPACE_ID::MessageLite>::GetOwningArena(
                reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(low_resolution_adaptive_voxel_filter_options));
    if (message_arena != submessage_arena) {
      low_resolution_adaptive_voxel_filter_options = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
...
inline bool LocalTrajectoryBuilderOptions3D::_internal_use_online_correlative_scan_matching() const {
...
inline void LocalTrajectoryBuilderOptions3D::_internal_set_use_online_correlative_scan_matching(bool value) {
...
// .cartographer.mapping.scan_matching.proto.RealTimeCorrelativeScanMatcherOptions real_time_correlative_scan_matcher_options = 14;
inline bool LocalTrajectoryBuilderOptions3D::_internal_has_real_time_correlative_scan_matcher_options() const {
...
inline const ::cartographer::mapping::scan_matching::proto::RealTimeCorrelativeScanMatcherOptions& LocalTrajectoryBuilderOptions3D::_internal_real_time_correlative_scan_matcher_options() const {
...
inline void LocalTrajectoryBuilderOptions3D::unsafe_arena_set_allocated_real_time_correlative_scan_matcher_options(
    ::cartographer::mapping::scan_matching::proto::RealTimeCorrelativeScanMatcherOptions* real_time_correlative_scan_matcher_options) {
  if (GetArenaForAllocation() == nullptr) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:cartographer.mapping.proto.LocalTrajectoryBuilderOptions3D.real_time_correlative_scan_matcher_options)
}
...
inline ::cartographer::mapping::scan_matching::proto::RealTimeCorrelativeScanMatcherOptions* LocalTrajectoryBuilderOptions3D::unsafe_arena_release_real_time_correlative_scan_matcher_options() {
...
inline ::cartographer::mapping::scan_matching::proto::RealTimeCorrelativeScanMatcherOptions* LocalTrajectoryBuilderOptions3D::_internal_mutable_real_time_correlative_scan_matcher_options() {
...
// .cartographer.mapping.scan_matching.proto.CeresScanMatcherOptions3D ceres_scan_matcher_options = 6;
inline bool LocalTrajectoryBuilderOptions3D::_internal_has_ceres_scan_matcher_options() const {
...
inline const ::cartographer::mapping::scan_matching::proto::CeresScanMatcherOptions3D& LocalTrajectoryBuilderOptions3D::_internal_ceres_scan_matcher_options() const {
...
inline void LocalTrajectoryBuilderOptions3D::unsafe_arena_set_allocated_ceres_scan_matcher_options(
    ::cartographer::mapping::scan_matching::proto::CeresScanMatcherOptions3D* ceres_scan_matcher_options) {
  if (GetArenaForAllocation() == nullptr) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:cartographer.mapping.proto.LocalTrajectoryBuilderOptions3D.ceres_scan_matcher_options)
}
...
inline ::cartographer::mapping::scan_matching::proto::CeresScanMatcherOptions3D* LocalTrajectoryBuilderOptions3D::unsafe_arena_release_ceres_scan_matcher_options() {
...
inline ::cartographer::mapping::scan_matching::proto::CeresScanMatcherOptions3D* LocalTrajectoryBuilderOptions3D::_internal_mutable_ceres_scan_matcher_options() {
  
  if (ceres_scan_matcher_options_ == nullptr) {
    auto* p = CreateMaybeMessage<::cartographer::mapping::scan_matching::proto::CeresScanMatcherOptions3D>(GetArenaForAllocation());
...
inline ::cartographer::mapping::scan_matching::proto::CeresScanMatcherOptions3D* LocalTrajectoryBuilderOptions3D::mutable_ceres_scan_matcher_options() {
  ::cartographer::mapping::scan_matching::proto::CeresScanMatcherOptions3D* _msg = _internal_mutable_ceres_scan_matcher_options();
...
// .cartographer.mapping.proto.MotionFilterOptions motion_filter_options = 7;
inline bool LocalTrajectoryBuilderOptions3D::_internal_has_motion_filter_options() const {
...
inline const ::cartographer::mapping::proto::MotionFilterOptions& LocalTrajectoryBuilderOptions3D::_internal_motion_filter_options() const {
...
inline void LocalTrajectoryBuilderOptions3D::unsafe_arena_set_allocated_motion_filter_options(
    ::cartographer::mapping::proto::MotionFilterOptions* motion_filter_options) {
  if (GetArenaForAllocation() == nullptr) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:cartographer.mapping.proto.LocalTrajectoryBuilderOptions3D.motion_filter_options)
}
...
inline ::cartographer::mapping::proto::MotionFilterOptions* LocalTrajectoryBuilderOptions3D::unsafe_arena_release_motion_filter_options() {
...
inline ::cartographer::mapping::proto::MotionFilterOptions* LocalTrajectoryBuilderOptions3D::_internal_mutable_motion_filter_options() {
...
inline double LocalTrajectoryBuilderOptions3D::_internal_imu_gravity_time_constant() const {
...
inline void LocalTrajectoryBuilderOptions3D::_internal_set_imu_gravity_time_constant(double value) {
...
inline ::PROTOBUF_NAMESPACE_ID::int32 LocalTrajectoryBuilderOptions3D::_internal_rotational_histogram_size() const {
  return rotational_histogram_size_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 LocalTrajectoryBuilderOptions3D::rotational_histogram_size() const {
  // @@protoc_insertion_point(field_get:cartographer.mapping.proto.LocalTrajectoryBuilderOptions3D.rotational_histogram_size)
  return _internal_rotational_histogram_size();
}
inline void LocalTrajectoryBuilderOptions3D::_internal_set_rotational_histogram_size(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  rotational_histogram_size_ = value;
}
inline void LocalTrajectoryBuilderOptions3D::set_rotational_histogram_size(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_rotational_histogram_size(value);
  // @@protoc_insertion_point(field_set:cartographer.mapping.proto.LocalTrajectoryBuilderOptions3D.rotational_histogram_size)
}

// .cartographer.mapping.proto.PoseExtrapolatorOptions pose_extrapolator_options = 18;
inline bool LocalTrajectoryBuilderOptions3D::_internal_has_pose_extrapolator_options() const {
...
inline const ::cartographer::mapping::proto::PoseExtrapolatorOptions& LocalTrajectoryBuilderOptions3D::_internal_pose_extrapolator_options() const {
...
inline void LocalTrajectoryBuilderOptions3D::unsafe_arena_set_allocated_pose_extrapolator_options(
    ::cartographer::mapping::proto::PoseExtrapolatorOptions* pose_extrapolator_options) {
  if (GetArenaForAllocation() == nullptr) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:cartographer.mapping.proto.LocalTrajectoryBuilderOptions3D.pose_extrapolator_options)
}
...
inline ::cartographer::mapping::proto::PoseExtrapolatorOptions* LocalTrajectoryBuilderOptions3D::unsafe_arena_release_pose_extrapolator_options() {
...
inline ::cartographer::mapping::proto::PoseExtrapolatorOptions* LocalTrajectoryBuilderOptions3D::_internal_mutable_pose_extrapolator_options() {
...
// repeated .cartographer.transform.proto.TimestampedTransform initial_poses = 19;
inline int LocalTrajectoryBuilderOptions3D::_internal_initial_poses_size() const {
  return initial_poses_.size();
}
inline int LocalTrajectoryBuilderOptions3D::initial_poses_size() const {
  return _internal_initial_poses_size();
}
...
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::cartographer::transform::proto::TimestampedTransform >*
...
inline const ::cartographer::transform::proto::TimestampedTransform& LocalTrajectoryBuilderOptions3D::_internal_initial_poses(int index) const {
...
inline const ::cartographer::transform::proto::TimestampedTransform& LocalTrajectoryBuilderOptions3D::initial_poses(int index) const {
  ...
  return _internal_initial_poses(index);
}
inline ::cartographer::transform::proto::TimestampedTransform* LocalTrajectoryBuilderOptions3D::_internal_add_initial_poses() {
...
inline ::cartographer::transform::proto::TimestampedTransform* LocalTrajectoryBuilderOptions3D::add_initial_poses() {
  ::cartographer::transform::proto::TimestampedTransform* _add = _internal_add_initial_poses();
  // @@protoc_insertion_point(field_add:cartographer.mapping.proto.LocalTrajectoryBuilderOptions3D.initial_poses)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::cartographer::transform::proto::TimestampedTransform >&
...
// repeated .cartographer.sensor.proto.ImuData initial_imu_data = 20;
inline int LocalTrajectoryBuilderOptions3D::_internal_initial_imu_data_size() const {
  return initial_imu_data_.size();
}
inline int LocalTrajectoryBuilderOptions3D::initial_imu_data_size() const {
  return _internal_initial_imu_data_size();
}
...
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::cartographer::sensor::proto::ImuData >*
...
inline const ::cartographer::sensor::proto::ImuData& LocalTrajectoryBuilderOptions3D::_internal_initial_imu_data(int index) const {
...
inline const ::cartographer::sensor::proto::ImuData& LocalTrajectoryBuilderOptions3D::initial_imu_data(int index) const {
  ...
  return _internal_initial_imu_data(index);
}
inline ::cartographer::sensor::proto::ImuData* LocalTrajectoryBuilderOptions3D::_internal_add_initial_imu_data() {
...
inline ::cartographer::sensor::proto::ImuData* LocalTrajectoryBuilderOptions3D::add_initial_imu_data() {
  ::cartographer::sensor::proto::ImuData* _add = _internal_add_initial_imu_data();
  // @@protoc_insertion_point(field_add:cartographer.mapping.proto.LocalTrajectoryBuilderOptions3D.initial_imu_data)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::cartographer::sensor::proto::ImuData >&
...
// .cartographer.mapping.proto.SubmapsOptions3D submaps_options = 8;
inline bool LocalTrajectoryBuilderOptions3D::_internal_has_submaps_options() const {
...
inline const ::cartographer::mapping::proto::SubmapsOptions3D& LocalTrajectoryBuilderOptions3D::_internal_submaps_options() const {
  const ::cartographer::mapping::proto::SubmapsOptions3D* p = submaps_options_;
  return p != nullptr ? *p : reinterpret_cast<const ::cartographer::mapping::proto::SubmapsOptions3D&>(
...
inline void LocalTrajectoryBuilderOptions3D::unsafe_arena_set_allocated_submaps_options(
    ::cartographer::mapping::proto::SubmapsOptions3D* submaps_options) {
  if (GetArenaForAllocation() == nullptr) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:cartographer.mapping.proto.LocalTrajectoryBuilderOptions3D.submaps_options)
}
...
inline ::cartographer::mapping::proto::SubmapsOptions3D* LocalTrajectoryBuilderOptions3D::unsafe_arena_release_submaps_options() {
...
inline ::cartographer::mapping::proto::SubmapsOptions3D* LocalTrajectoryBuilderOptions3D::_internal_mutable_submaps_options() {
  
  if (submaps_options_ == nullptr) {
    auto* p = CreateMaybeMessage<::cartographer::mapping::proto::SubmapsOptions3D>(GetArenaForAllocation());
    submaps_options_ = p;
  }
...
inline ::cartographer::mapping::proto::SubmapsOptions3D* LocalTrajectoryBuilderOptions3D::mutable_submaps_options() {
  ::cartographer::mapping::proto::SubmapsOptions3D* _msg = _internal_mutable_submaps_options();
...
inline bool LocalTrajectoryBuilderOptions3D::_internal_use_intensities() const {
...
inline bool LocalTrajectoryBuilderOptions3D::use_intensities() const {
  ...
  return _internal_use_intensities();
}
inline void LocalTrajectoryBuilderOptions3D::_internal_set_use_intensities(bool value) {
  
  use_intensities_ = value;
}
inline void LocalTrajectoryBuilderOptions3D::set_use_intensities(bool value) {
  _internal_set_use_intensities(value);
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_cartographer_2fmapping_2fproto_2flocal_5ftrajectory_5fbuilder_5foptions_5f3d_2eproto
