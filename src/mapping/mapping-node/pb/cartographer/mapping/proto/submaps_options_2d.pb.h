...
class SubmapsOptions2D final :
 ...
 public:
  ...
  explicit constexpr SubmapsOptions2D(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  PROTOBUF_MUST_USE_RESULT ::cartographer::mapping::proto::GridOptions2D* release_grid_options_2d();
  ...
  PROTOBUF_MUST_USE_RESULT ::cartographer::mapping::proto::RangeDataInserterOptions* release_range_data_inserter_options();
