...
namespace mapping {
namespace proto {
constexpr Grid2D_CellBox::Grid2D_CellBox(
...
struct Grid2D_CellBoxDefaultTypeInternal {
  constexpr Grid2D_CellBoxDefaultTypeInternal()
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT Grid2D_CellBoxDefaultTypeInternal _Grid2D_CellBox_default_instance_;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_cartographer_2fmapping_2fproto_2fgrid_5f2d_2eproto = {
  false, false, 642, descriptor_table_protodef_cartographer_2fmapping_2fproto_2fgrid_5f2d_2eproto, "cartographer/mapping/proto/grid_2d.proto", 
  ...
  file_level_metadata_cartographer_2fmapping_2fproto_2fgrid_5f2d_2eproto, file_level_enum_descriptors_cartographer_2fmapping_2fproto_2fgrid_5f2d_2eproto, file_level_service_descriptors_cartographer_2fmapping_2fproto_2fgrid_5f2d_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_cartographer_2fmapping_2fproto_2fgrid_5f2d_2eproto_getter() {
  return &descriptor_table_cartographer_2fmapping_2fproto_2fgrid_5f2d_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_cartographer_2fmapping_2fproto_2fgrid_5f2d_2eproto(&descriptor_table_cartographer_2fmapping_2fproto_2fgrid_5f2d_2eproto);
namespace cartographer {
namespace mapping {
namespace proto {
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    reinterpret_cast<char*>(&max_x_) - reinterpret_cast<char*>(this)),
    0, static_cast<size_t>(reinterpret_cast<char*>(&min_y_) -
    reinterpret_cast<char*>(&max_x_)) + sizeof(min_y_));
}
...
// @@protoc_insertion_point(message_byte_size_start:cartographer.mapping.proto.Grid2D.CellBox)
  ...
  // int32 max_x = 1;
  if (this->_internal_max_x() != 0) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int32SizePlusOne(this->_internal_max_x());
  }

  // int32 max_y = 2;
  if (this->_internal_max_y() != 0) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int32SizePlusOne(this->_internal_max_y());
  }

  // int32 min_x = 3;
  if (this->_internal_min_x() != 0) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int32SizePlusOne(this->_internal_min_x());
  }

  // int32 min_y = 4;
  if (this->_internal_min_y() != 0) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int32SizePlusOne(this->_internal_min_y());
  }
...
void Grid2D_CellBox::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<Grid2D_CellBox *>(to)->MergeFrom(
      static_cast<const Grid2D_CellBox &>(from));
}
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    ...
    0, static_cast<size_t>(reinterpret_cast<char*>(&max_correspondence_cost_) -
...
// @@protoc_insertion_point(message_clear_start:cartographer.mapping.proto.Grid2D)
  ...
  limits_ = nullptr;
  if (GetArenaForAllocation() == nullptr && known_cells_box_ != nullptr) {
...
::PROTOBUF_NAMESPACE_ID::uint8* Grid2D::_InternalSerialize(
  ...
  // float min_correspondence_cost = 6;
  if (!(this->_internal_min_correspondence_cost() <= 0 && this->_internal_min_correspondence_cost() >= 0)) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteFloatToArray(6, this->_internal_min_correspondence_cost(), target);
  }

  // float max_correspondence_cost = 7;
  if (!(this->_internal_max_correspondence_cost() <= 0 && this->_internal_max_correspondence_cost() >= 0)) {
    target = stream->EnsureSpace(target);
...
void Grid2D::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<Grid2D *>(to)->MergeFrom(
      static_cast<const Grid2D &>(from));
}
...
// @@protoc_insertion_point(class_specific_merge_from_start:cartographer.mapping.proto.Grid2D)
  ...
  if (!(from._internal_min_correspondence_cost() <= 0 && from._internal_min_correspondence_cost() >= 0)) {
    _internal_set_min_correspondence_cost(from._internal_min_correspondence_cost());
  }
  if (!(from._internal_max_correspondence_cost() <= 0 && from._internal_max_correspondence_cost() >= 0)) {
