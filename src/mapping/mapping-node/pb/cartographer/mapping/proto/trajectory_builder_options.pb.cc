...
namespace mapping {
namespace proto {
constexpr InitialTrajectoryPose::InitialTrajectoryPose(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : relative_pose_(nullptr)
  , timestamp_(int64_t{0})
  , to_trajectory_id_(0){}
struct InitialTrajectoryPoseDefaultTypeInternal {
  constexpr InitialTrajectoryPoseDefaultTypeInternal()
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT InitialTrajectoryPoseDefaultTypeInternal _InitialTrajectoryPose_default_instance_;
constexpr TrajectoryBuilderOptions_PureLocalizationTrimmerOptions::TrajectoryBuilderOptions_PureLocalizationTrimmerOptions(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : max_submaps_to_keep_(0){}
struct TrajectoryBuilderOptions_PureLocalizationTrimmerOptionsDefaultTypeInternal {
  constexpr TrajectoryBuilderOptions_PureLocalizationTrimmerOptionsDefaultTypeInternal()
    : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT TrajectoryBuilderOptions_PureLocalizationTrimmerOptionsDefaultTypeInternal _TrajectoryBuilderOptions_PureLocalizationTrimmerOptions_default_instance_;
constexpr TrajectoryBuilderOptions::TrajectoryBuilderOptions(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
...
struct TrajectoryBuilderOptionsDefaultTypeInternal {
  constexpr TrajectoryBuilderOptionsDefaultTypeInternal()
    : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT TrajectoryBuilderOptionsDefaultTypeInternal _TrajectoryBuilderOptions_default_instance_;
constexpr SensorId::SensorId(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : id_(&::PROTOBUF_NAMESPACE_ID::internal::fixed_address_empty_string)
  , type_(0)
{}
struct SensorIdDefaultTypeInternal {
  constexpr SensorIdDefaultTypeInternal()
    : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT SensorIdDefaultTypeInternal _SensorId_default_instance_;
constexpr TrajectoryBuilderOptionsWithSensorIds::TrajectoryBuilderOptionsWithSensorIds(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : sensor_id_()
  , trajectory_builder_options_(nullptr){}
struct TrajectoryBuilderOptionsWithSensorIdsDefaultTypeInternal {
  constexpr TrajectoryBuilderOptionsWithSensorIdsDefaultTypeInternal()
    : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT TrajectoryBuilderOptionsWithSensorIdsDefaultTypeInternal _TrajectoryBuilderOptionsWithSensorIds_default_instance_;
constexpr AllTrajectoryBuilderOptions::AllTrajectoryBuilderOptions(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : options_with_sensor_ids_(){}
struct AllTrajectoryBuilderOptionsDefaultTypeInternal {
  constexpr AllTrajectoryBuilderOptionsDefaultTypeInternal()
    : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT AllTrajectoryBuilderOptionsDefaultTypeInternal _AllTrajectoryBuilderOptions_default_instance_;
}  // namespace proto
}  // namespace mapping
}  // namespace cartographer
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_cartographer_2fmapping_2fproto_2ftrajectory_5fbuilder_5foptions_2eproto = {
  false, false, 1669, descriptor_table_protodef_cartographer_2fmapping_2fproto_2ftrajectory_5fbuilder_5foptions_2eproto, "cartographer/mapping/proto/trajectory_builder_options.proto", 
  ...
  file_level_metadata_cartographer_2fmapping_2fproto_2ftrajectory_5fbuilder_5foptions_2eproto, file_level_enum_descriptors_cartographer_2fmapping_2fproto_2ftrajectory_5fbuilder_5foptions_2eproto, file_level_service_descriptors_cartographer_2fmapping_2fproto_2ftrajectory_5fbuilder_5foptions_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_cartographer_2fmapping_2fproto_2ftrajectory_5fbuilder_5foptions_2eproto_getter() {
  return &descriptor_table_cartographer_2fmapping_2fproto_2ftrajectory_5fbuilder_5foptions_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_cartographer_2fmapping_2fproto_2ftrajectory_5fbuilder_5foptions_2eproto(&descriptor_table_cartographer_2fmapping_2fproto_2ftrajectory_5fbuilder_5foptions_2eproto);
namespace cartographer {
namespace mapping {
namespace proto {
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    reinterpret_cast<char*>(&relative_pose_) - reinterpret_cast<char*>(this)),
    0, static_cast<size_t>(reinterpret_cast<char*>(&to_trajectory_id_) -
...
// @@protoc_insertion_point(message_byte_size_start:cartographer.mapping.proto.InitialTrajectoryPose)
  ...
  // int32 to_trajectory_id = 2;
  if (this->_internal_to_trajectory_id() != 0) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int32SizePlusOne(this->_internal_to_trajectory_id());
  }
...
void InitialTrajectoryPose::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<InitialTrajectoryPose *>(to)->MergeFrom(
      static_cast<const InitialTrajectoryPose &>(from));
}
...
// @@protoc_insertion_point(message_byte_size_start:cartographer.mapping.proto.TrajectoryBuilderOptions.PureLocalizationTrimmerOptions)
  ...
  // int32 max_submaps_to_keep = 1;
  if (this->_internal_max_submaps_to_keep() != 0) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int32SizePlusOne(this->_internal_max_submaps_to_keep());
  }
...
void TrajectoryBuilderOptions_PureLocalizationTrimmerOptions::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<TrajectoryBuilderOptions_PureLocalizationTrimmerOptions *>(to)->MergeFrom(
      static_cast<const TrajectoryBuilderOptions_PureLocalizationTrimmerOptions &>(from));
}
...
void TrajectoryBuilderOptions::clear_trajectory_builder_2d_options() {
  if (GetArenaForAllocation() == nullptr && trajectory_builder_2d_options_ != nullptr) {
    delete trajectory_builder_2d_options_;
  }
  trajectory_builder_2d_options_ = nullptr;
}
void TrajectoryBuilderOptions::clear_trajectory_builder_3d_options() {
  if (GetArenaForAllocation() == nullptr && trajectory_builder_3d_options_ != nullptr) {
    delete trajectory_builder_3d_options_;
  }
  trajectory_builder_3d_options_ = nullptr;
}
void TrajectoryBuilderOptions::clear_pose_graph_odometry_motion_filter() {
  if (GetArenaForAllocation() == nullptr && pose_graph_odometry_motion_filter_ != nullptr) {
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    reinterpret_cast<char*>(&trajectory_builder_2d_options_) - reinterpret_cast<char*>(this)),
    0, static_cast<size_t>(reinterpret_cast<char*>(&collate_landmarks_) -
...
// @@protoc_insertion_point(message_clear_start:cartographer.mapping.proto.TrajectoryBuilderOptions)
  ...
  trajectory_builder_3d_options_ = nullptr;
  if (GetArenaForAllocation() == nullptr && initial_trajectory_pose_ != nullptr) {
    delete initial_trajectory_pose_;
  }
  initial_trajectory_pose_ = nullptr;
  if (GetArenaForAllocation() == nullptr && pure_localization_trimmer_ != nullptr) {
...
void TrajectoryBuilderOptions::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<TrajectoryBuilderOptions *>(to)->MergeFrom(
      static_cast<const TrajectoryBuilderOptions &>(from));
}
...
void SensorId::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<SensorId *>(to)->MergeFrom(
      static_cast<const SensorId &>(from));
}
...
// @@protoc_insertion_point(message_clear_start:cartographer.mapping.proto.TrajectoryBuilderOptionsWithSensorIds)
  ...
  sensor_id_.Clear();
  if (GetArenaForAllocation() == nullptr && trajectory_builder_options_ != nullptr) {
...
void TrajectoryBuilderOptionsWithSensorIds::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<TrajectoryBuilderOptionsWithSensorIds *>(to)->MergeFrom(
      static_cast<const TrajectoryBuilderOptionsWithSensorIds &>(from));
}
...
void AllTrajectoryBuilderOptions::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<AllTrajectoryBuilderOptions *>(to)->MergeFrom(
      static_cast<const AllTrajectoryBuilderOptions &>(from));
}
