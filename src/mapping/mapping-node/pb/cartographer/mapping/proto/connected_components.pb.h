...
class ConnectedComponents_ConnectedComponent final :
 ...
 public:
  ...
  explicit constexpr ConnectedComponents_ConnectedComponent(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class ConnectedComponents final :
 ...
 public:
  ...
  explicit constexpr ConnectedComponents(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
