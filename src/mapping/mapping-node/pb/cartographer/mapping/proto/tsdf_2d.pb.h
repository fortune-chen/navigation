...
class TSDF2D final :
 ...
 public:
  inline TSDF2D() : TSDF2D(nullptr) {}
  ~TSDF2D() override;
  explicit constexpr TSDF2D(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void UnsafeArenaSwap(TSDF2D* other) {
    if (other == this) return;
  ...
  protected:
  explicit TSDF2D(::PROTOBUF_NAMESPACE_ID::Arena* arena,
