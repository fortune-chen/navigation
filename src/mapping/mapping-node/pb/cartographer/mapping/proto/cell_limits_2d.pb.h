...
class CellLimits final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:cartographer.mapping.proto.CellLimits) */ {
 public:
  inline CellLimits() : CellLimits(nullptr) {}
  ~CellLimits() override;
  explicit constexpr CellLimits(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void UnsafeArenaSwap(CellLimits* other) {
    if (other == this) return;
  ...
  protected:
  explicit CellLimits(::PROTOBUF_NAMESPACE_ID::Arena* arena,
