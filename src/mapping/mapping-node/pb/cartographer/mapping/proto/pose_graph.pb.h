...
class SubmapId final :
 ...
 public:
  ...
  ~SubmapId() override;
  explicit constexpr SubmapId(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class PoseGraph_Constraint final :
 ...
 public:
  ...
  explicit constexpr PoseGraph_Constraint(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  inline PoseGraph_Constraint* New() const final {
    return new PoseGraph_Constraint();
  }
...
class PoseGraph_LandmarkPose final :
 ...
 public:
  ...
  explicit constexpr PoseGraph_LandmarkPose(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  inline PoseGraph_LandmarkPose* New() const final {
    return new PoseGraph_LandmarkPose();
  }
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_landmark_id();
  ...
  PROTOBUF_MUST_USE_RESULT ::cartographer::transform::proto::Rigid3d* release_global_pose();
...
class PoseGraph final :
 ...
 public:
  ...
  ~PoseGraph() override;
  explicit constexpr PoseGraph(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
inline void PoseGraph_Constraint::set_allocated_submap_id(::cartographer::mapping::proto::SubmapId* submap_id) {
  ...
  if (submap_id) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::cartographer::mapping::proto::SubmapId>::GetOwningArena(submap_id);
...
inline void PoseGraph_Constraint::set_allocated_node_id(::cartographer::mapping::proto::NodeId* node_id) {
  ...
  if (node_id) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::cartographer::mapping::proto::NodeId>::GetOwningArena(node_id);
    if (message_arena != submessage_arena) {
...
void PoseGraph_LandmarkPose::set_landmark_id(ArgT0&& arg0, ArgT... args) {
 ...
 landmark_id_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline const std::string& PoseGraph_LandmarkPose::_internal_landmark_id() const {
  return landmark_id_.Get();
}
inline void PoseGraph_LandmarkPose::_internal_set_landmark_id(const std::string& value) {
  
  landmark_id_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* PoseGraph_LandmarkPose::_internal_mutable_landmark_id() {
  
  return landmark_id_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* PoseGraph_LandmarkPose::release_landmark_id() {
  ...
  return landmark_id_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
inline void PoseGraph_LandmarkPose::set_allocated_landmark_id(std::string* landmark_id) {
  ...
  landmark_id_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), landmark_id,
