...
class Trajectory_Node final :
 ...
 public:
  ...
  explicit constexpr Trajectory_Node(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class Trajectory_Submap final :
 ...
 public:
  ...
  explicit constexpr Trajectory_Submap(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
