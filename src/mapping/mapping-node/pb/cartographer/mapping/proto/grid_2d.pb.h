...
class Grid2D_CellBox final :
 ...
 public:
  ...
  explicit constexpr Grid2D_CellBox(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class Grid2D final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::cartographer::mapping::proto::MapLimits* release_limits();
  ...
  PROTOBUF_MUST_USE_RESULT ::cartographer::mapping::proto::Grid2D_CellBox* release_known_cells_box();
  ...
  PROTOBUF_MUST_USE_RESULT ::cartographer::mapping::proto::ProbabilityGrid* release_probability_grid_2d();
  ...
  PROTOBUF_MUST_USE_RESULT ::cartographer::mapping::proto::TSDF2D* release_tsdf_2d();
...
inline void Grid2D::unsafe_arena_set_allocated_known_cells_box(
    ::cartographer::mapping::proto::Grid2D_CellBox* known_cells_box) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(known_cells_box_);
  }
...
inline void Grid2D::set_allocated_known_cells_box(::cartographer::mapping::proto::Grid2D_CellBox* known_cells_box) {
  ...
  if (known_cells_box) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::cartographer::mapping::proto::Grid2D_CellBox>::GetOwningArena(known_cells_box);
    if (message_arena != submessage_arena) {
...
inline ::cartographer::mapping::proto::ProbabilityGrid* Grid2D::_internal_mutable_probability_grid_2d() {
  if (!_internal_has_probability_grid_2d()) {
    clear_grid();
    set_has_probability_grid_2d();
    grid_.probability_grid_2d_ = CreateMaybeMessage< ::cartographer::mapping::proto::ProbabilityGrid >(GetArenaForAllocation());
  }
...
inline ::cartographer::mapping::proto::TSDF2D* Grid2D::_internal_mutable_tsdf_2d() {
  if (!_internal_has_tsdf_2d()) {
    clear_grid();
    set_has_tsdf_2d();
    grid_.tsdf_2d_ = CreateMaybeMessage< ::cartographer::mapping::proto::TSDF2D >(GetArenaForAllocation());
  }
