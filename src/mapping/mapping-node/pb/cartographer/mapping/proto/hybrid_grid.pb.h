...
class HybridGrid final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:cartographer.mapping.proto.HybridGrid) */ {
 public:
  inline HybridGrid() : HybridGrid(nullptr) {}
  ~HybridGrid() override;
  explicit constexpr HybridGrid(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void UnsafeArenaSwap(HybridGrid* other) {
    if (other == this) return;
  ...
  protected:
  explicit HybridGrid(::PROTOBUF_NAMESPACE_ID::Arena* arena,
