...
class IntensityCostFunctionOptions final :
 ...
 public:
  ...
  ~IntensityCostFunctionOptions() override;
  explicit constexpr IntensityCostFunctionOptions(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  inline IntensityCostFunctionOptions* New() const final {
    return new IntensityCostFunctionOptions();
  }
...
class CeresScanMatcherOptions3D final :
 ...
 public:
  ...
  ~CeresScanMatcherOptions3D() override;
  explicit constexpr CeresScanMatcherOptions3D(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  inline CeresScanMatcherOptions3D* New() const final {
    return new CeresScanMatcherOptions3D();
  }
  ...
  PROTOBUF_MUST_USE_RESULT ::cartographer::common::proto::CeresSolverOptions* release_ceres_solver_options();
...
inline ::cartographer::mapping::scan_matching::proto::IntensityCostFunctionOptions* CeresScanMatcherOptions3D::add_intensity_cost_function_options() {
  ::cartographer::mapping::scan_matching::proto::IntensityCostFunctionOptions* _add = _internal_add_intensity_cost_function_options();
