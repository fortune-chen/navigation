...
namespace proto {
constexpr FastCorrelativeScanMatcherOptions3D::FastCorrelativeScanMatcherOptions3D(
...
struct FastCorrelativeScanMatcherOptions3DDefaultTypeInternal {
  constexpr FastCorrelativeScanMatcherOptions3DDefaultTypeInternal()
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT FastCorrelativeScanMatcherOptions3DDefaultTypeInternal _FastCorrelativeScanMatcherOptions3D_default_instance_;
}  // namespace proto
}  // namespace scan_matching
}  // namespace mapping
}  // namespace cartographer
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_cartographer_2fmapping_2fproto_2fscan_5fmatching_2ffast_5fcorrelative_5fscan_5fmatcher_5foptions_5f3d_2eproto = {
  false, false, 402, descriptor_table_protodef_cartographer_2fmapping_2fproto_2fscan_5fmatching_2ffast_5fcorrelative_5fscan_5fmatcher_5foptions_5f3d_2eproto, "cartographer/mapping/proto/scan_matching/fast_correlative_scan_matcher_options_3d.proto", 
  ...
  file_level_metadata_cartographer_2fmapping_2fproto_2fscan_5fmatching_2ffast_5fcorrelative_5fscan_5fmatcher_5foptions_5f3d_2eproto, file_level_enum_descriptors_cartographer_2fmapping_2fproto_2fscan_5fmatching_2ffast_5fcorrelative_5fscan_5fmatcher_5foptions_5f3d_2eproto, file_level_service_descriptors_cartographer_2fmapping_2fproto_2fscan_5fmatching_2ffast_5fcorrelative_5fscan_5fmatcher_5foptions_5f3d_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_cartographer_2fmapping_2fproto_2fscan_5fmatching_2ffast_5fcorrelative_5fscan_5fmatcher_5foptions_5f3d_2eproto_getter() {
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_cartographer_2fmapping_2fproto_2fscan_5fmatching_2ffast_5fcorrelative_5fscan_5fmatcher_5foptions_5f3d_2eproto(&descriptor_table_cartographer_2fmapping_2fproto_2fscan_5fmatching_2ffast_5fcorrelative_5fscan_5fmatcher_5foptions_5f3d_2eproto);
namespace cartographer {
namespace mapping {
namespace scan_matching {
namespace proto {
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    reinterpret_cast<char*>(&min_rotational_score_) - reinterpret_cast<char*>(this)),
    0, static_cast<size_t>(reinterpret_cast<char*>(&min_low_resolution_score_) -
    reinterpret_cast<char*>(&min_rotational_score_)) + sizeof(min_low_resolution_score_));
}
...
void FastCorrelativeScanMatcherOptions3D::ArenaDtor(void* object) {
  FastCorrelativeScanMatcherOptions3D* _this = reinterpret_cast< FastCorrelativeScanMatcherOptions3D* >(object);
  (void)_this;
}
void FastCorrelativeScanMatcherOptions3D::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
    ...
    switch (tag >> 3) {
      ...
      case 8:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 64)) {
          full_resolution_depth_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
::PROTOBUF_NAMESPACE_ID::uint8* FastCorrelativeScanMatcherOptions3D::_InternalSerialize(
  ...
  // double min_rotational_score = 4;
  if (!(this->_internal_min_rotational_score() <= 0 && this->_internal_min_rotational_score() >= 0)) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteDoubleToArray(4, this->_internal_min_rotational_score(), target);
  }

  // double linear_xy_search_window = 5;
  if (!(this->_internal_linear_xy_search_window() <= 0 && this->_internal_linear_xy_search_window() >= 0)) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteDoubleToArray(5, this->_internal_linear_xy_search_window(), target);
  }

  // double linear_z_search_window = 6;
  if (!(this->_internal_linear_z_search_window() <= 0 && this->_internal_linear_z_search_window() >= 0)) {
    target = stream->EnsureSpace(target);
  ...
  // double min_low_resolution_score = 9;
  if (!(this->_internal_min_low_resolution_score() <= 0 && this->_internal_min_low_resolution_score() >= 0)) {
    target = stream->EnsureSpace(target);
...
// @@protoc_insertion_point(message_byte_size_start:cartographer.mapping.scan_matching.proto.FastCorrelativeScanMatcherOptions3D)
  ...
  // int32 full_resolution_depth = 8;
  if (this->_internal_full_resolution_depth() != 0) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int32SizePlusOne(this->_internal_full_resolution_depth());
  }
...
void FastCorrelativeScanMatcherOptions3D::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<FastCorrelativeScanMatcherOptions3D *>(to)->MergeFrom(
      static_cast<const FastCorrelativeScanMatcherOptions3D &>(from));
}
...
// @@protoc_insertion_point(class_specific_merge_from_start:cartographer.mapping.scan_matching.proto.FastCorrelativeScanMatcherOptions3D)
  ...
  if (!(from._internal_min_rotational_score() <= 0 && from._internal_min_rotational_score() >= 0)) {
    _internal_set_min_rotational_score(from._internal_min_rotational_score());
  }
  if (!(from._internal_linear_xy_search_window() <= 0 && from._internal_linear_xy_search_window() >= 0)) {
  ...
  if (!(from._internal_linear_z_search_window() <= 0 && from._internal_linear_z_search_window() >= 0)) {
  ...
  if (!(from._internal_min_low_resolution_score() <= 0 && from._internal_min_low_resolution_score() >= 0)) {
...
void FastCorrelativeScanMatcherOptions3D::InternalSwap(FastCorrelativeScanMatcherOptions3D* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(FastCorrelativeScanMatcherOptions3D, min_low_resolution_score_)
      + sizeof(FastCorrelativeScanMatcherOptions3D::min_low_resolution_score_)
      - PROTOBUF_FIELD_OFFSET(FastCorrelativeScanMatcherOptions3D, min_rotational_score_)>(
          reinterpret_cast<char*>(&min_rotational_score_),
          reinterpret_cast<char*>(&other->min_rotational_score_));
}
