...
class RealTimeCorrelativeScanMatcherOptions final :
 ...
 public:
  ...
  ~RealTimeCorrelativeScanMatcherOptions() override;
  explicit constexpr RealTimeCorrelativeScanMatcherOptions(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
