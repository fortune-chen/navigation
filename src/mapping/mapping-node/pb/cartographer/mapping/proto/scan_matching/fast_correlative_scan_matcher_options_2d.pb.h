...
class FastCorrelativeScanMatcherOptions2D final :
 ...
 public:
  inline FastCorrelativeScanMatcherOptions2D() : FastCorrelativeScanMatcherOptions2D(nullptr) {}
  ~FastCorrelativeScanMatcherOptions2D() override;
  explicit constexpr FastCorrelativeScanMatcherOptions2D(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void UnsafeArenaSwap(FastCorrelativeScanMatcherOptions2D* other) {
    if (other == this) return;
  ...
  inline FastCorrelativeScanMatcherOptions2D* New() const final {
    return new FastCorrelativeScanMatcherOptions2D();
  }
  ...
  protected:
  explicit FastCorrelativeScanMatcherOptions2D(::PROTOBUF_NAMESPACE_ID::Arena* arena,
