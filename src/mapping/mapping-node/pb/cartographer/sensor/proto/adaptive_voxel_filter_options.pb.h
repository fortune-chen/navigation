...
class AdaptiveVoxelFilterOptions final :
 ...
 public:
  ...
  ~AdaptiveVoxelFilterOptions() override;
  explicit constexpr AdaptiveVoxelFilterOptions(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
