...
struct PidConfig {
  ...
  double Kd_ang = 0.30f;
  double l = 0.5f;
  bool feedback_long = true;
  bool feedback_lat = true;
  bool feedback_ang = true;
  bool feedforward_long = true;
  bool feedforward_lat = true;
  bool feedforward_ang = false;
  double max_yaw_error_cal = 0.0f;
  double dead_zone_yaw_error_cal = 0.06f;
  bool coupling_ang_long = false;
  bool controller_debug_enabled = true;
};
...
public:
  ...
  //                             const ros::Duration sample_time, tracking_pid::PidDebug* pid_debug);
  geometry_msgs::Twist update(const geometry_msgs::Transform current, const tf::Transform goal,
                              const ros::Duration sample_time);
  geometry_msgs::Twist update(const geometry_msgs::Transform current, const geometry_msgs::Pose goal,
                              const ros::Duration sample_time);
  /**
